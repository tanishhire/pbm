    ...
    <div className='w-full mx-auto bg-[#fff] text-[#1b262c] justify-center items-center h-auto py-[100px] md:py-[150px] md:py-auto'>
        <div className='w-4/5 md:w-3/4 h-[90%]  mx-auto items-between md:flex md:flex-row '>
            ...
            <div className='flex flex-col my-10 md:my-0 w-full md:w-[25%] mr-24'>
                ...
                <p className='my-3 cursor-pointer hover:scale-105 duration-500 hover:text-[#1063e5]'><a href='/#/services' >Services</a></p>    
                <p className='my-3 cursor-pointer hover:scale-105 duration-500 hover:text-[#1063e5]'><a href='/#/contact' >Contact</a></p>
                <p className='my-3 cursor-pointer hover:scale-105 duration-500 hover:text-[#1063e5]'><a href='/#/about' >About</a></p>
            </div>
